...
if (-not ("RhinoFSharpTemplate.NativeResourceCounters" -as [type])) {
...
$initialGdiObjects = [RhinoFSharpTemplate.NativeResourceCounters]::GetGuiResources($process.Handle, 0)
$initialUserObjects = [RhinoFSharpTemplate.NativeResourceCounters]::GetGuiResources($process.Handle, 1)
...
while (-not $process.HasExited) {
    ...
    $gdiObjects = [RhinoFSharpTemplate.NativeResourceCounters]::GetGuiResources($process.Handle, 0)
    $userObjects = [RhinoFSharpTemplate.NativeResourceCounters]::GetGuiResources($process.Handle, 1)
